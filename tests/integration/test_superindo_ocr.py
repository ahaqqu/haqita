"""
Integration test: OCR on a single brochure image using Ollama.
Requires: Ollama running locally, qwen3-vl model installed.

Usage:
    python tests/integration/test_ocr_image.py [--image path/to/image.jpg] [--model model_name]
...
def main():
    ...
    print("=" * 60)
    print("  Integration Test: OCR on Brochure Image")
    print("=" * 60)
    print()
