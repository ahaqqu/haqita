...
def consolidate(cfg: dict, lotte_dir: Path | None, superindo_dir: Path | None, database_dir: Path, log_file: Path | None = None) -> None:
    t_start = time.time()
...
def main():
    ...
    consolidate(cfg, lotte_dir, superindo_dir, database_dir, log_file)
