_SUPERINDO = """Extract all product promotions from this Superindo supermarket brochure image.
...
_LOTTE = """Extract all product promotions from this Lotte Mart supermarket brochure image.
