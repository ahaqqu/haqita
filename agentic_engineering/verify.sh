#!/usr/bin/env bash
# agentic_engineering/verify.sh — Run the full agentic verification in an isolated temp workspace.
#
...
#
# Usage:
#   bash agentic_engineering/verify.sh                # full run, cleanup on exit
#   bash agentic_engineering/verify.sh --keep         # preserve temp workspace
#   bash agentic_engineering/verify.sh --skip-sync    # skip Cloudflare sync
#   bash agentic_engineering/verify.sh --skip-tabs    # skip tab assertions
